          ...
          <table className="w-full text-sm min-w-[640px]">
            <thead>
              <tr className="border-b border-slate-200 text-left">
                ...
                <th className="px-5 py-3 text-xs uppercase font-semibold text-slate-400 text-right">Amount</th>
              ...
              {rows.map(row => {
                ...
                return (
                  <tr key={row.id} className="border-b border-slate-100 last:border-0">
                    <td className="px-5 py-4 text-slate-600 whitespace-nowrap">{shortDate(row.created_at)}</td>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2">
                        <span className={`text-xs font-semibold px-2 py-1 rounded-full border ${status.className}`}>
                          {status.label}
                        </span>
